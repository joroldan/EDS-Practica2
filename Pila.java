...
public class Pila<T>
{
	...
	public T cima() //devuelve el dato correspondiente al elemento que se ha puesto el ultimo a la Pila
	{
		if (this.registro==null) return null;
		else return this.registro.dato;
	}

	public T desapilar() //elimina y devuelve el ultimo elemento que se ha puesto
	{
		if (this.registro==null)  return null;
		else
		{
